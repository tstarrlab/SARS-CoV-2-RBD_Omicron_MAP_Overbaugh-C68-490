...
```
    ...
    Plotting correlations of mutation escape for C68_490_WH1
...
![png](make_supp_data_Wuhan_Hu_1_files/make_supp_data_Wuhan_Hu_1_16_1.png)
    ...
    Saving plot to results/supp_data/Wuhan_Hu_1/C68_490_WH1-mutation-corr.pdf
    
    Plotting correlations of site escape for C68_490_WH1
...
![png](make_supp_data_Wuhan_Hu_1_files/make_supp_data_Wuhan_Hu_1_16_3.png)
    ...
    Saving plot to results/supp_data/Wuhan_Hu_1/C68_490_WH1-site-corr.pdf
...
```
    ...
    Raw data for C68_490_WH1:
    Writing to results/supp_data/Wuhan_Hu_1/C68_490_WH1_raw_data.csv
...
```
    ...
    Writing `dms-view` input file for C68_490_WH1 mapped to PDB 6m0j to results/supp_data/Wuhan_Hu_1/C68_490_WH1_6m0j_dms-view_data.csv
