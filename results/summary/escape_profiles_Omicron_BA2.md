...
```
    ...
    /scratch/local/u6042467/1486273/ipykernel_3291892/3576878265.py:38: MatplotlibDeprecationWarning: The get_cmap function was deprecated in Matplotlib 3.7 and will be removed two minor releases later. Use ``matplotlib.colormaps[name]`` or ``matplotlib.colormaps.get_cmap(obj)`` instead.
...
```
    ...
    Plotted profile 1 to:
     results/escape_profiles/Omicron_BA2/C68_490_BA2_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/C68_490_BA2_stackedlogo.png.
...
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_26_3.png)
    ...
    Plotted profile 2 to:
     results/escape_profiles/Omicron_BA2/C68_490_BA2_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/C68_490_BA2_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_26_5.png)
    ...
    Plotted profile 3 to:
     results/escape_profiles/Omicron_BA2/C68_490_BA2_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/C68_490_BA2_color_by_expr_stackedlogo.png.
