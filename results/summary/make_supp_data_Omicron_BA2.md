...
```
    ...
    Plotting correlations of mutation escape for C68_490_BA2
...
![png](make_supp_data_Omicron_BA2_files/make_supp_data_Omicron_BA2_16_1.png)
    ...
    Saving plot to results/supp_data/Omicron_BA2/C68_490_BA2-mutation-corr.pdf
    
    Plotting correlations of site escape for C68_490_BA2
...
![png](make_supp_data_Omicron_BA2_files/make_supp_data_Omicron_BA2_16_3.png)
    ...
    Saving plot to results/supp_data/Omicron_BA2/C68_490_BA2-site-corr.pdf
...
```
    ...
    Raw data for C68_490_BA2:
    Writing to results/supp_data/Omicron_BA2/C68_490_BA2_raw_data.csv
...
```
    ...
    Writing `dms-view` input file for C68_490_BA2 mapped to PDB 6m0j to results/supp_data/Omicron_BA2/C68_490_BA2_6m0j_dms-view_data.csv
